...
public class ComentarioController {
    ...
    @PutMapping("/{id}")
    public ComentarioDto actualizar(@PathVariable Long id, @RequestBody ComentarioDtoTransaccion comentario) {
        return new ComentarioDto(comentarioService.actualizar(id, comentario));
    }
